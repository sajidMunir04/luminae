...
{ 
    ...
    return (<div onMouseEnter={() => setHoverState(!isHovered)} onTouchStart={() => setHoverState(!isHovered)} className={styles.container}><motion.p className={styles.categoryButton} whileHover={{scale: 1.5}}>{props.mainCategory}</motion.p>
